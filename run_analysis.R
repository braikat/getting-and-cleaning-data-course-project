...
# read training data
trnSubj <- read.table(file.path(dataPath, "train", "subject_train.txt"))
trnVal <- read.table(file.path(dataPath, "train", "X_train.txt"))
...
humanActivity <- rbind(
  cbind(trnSubj, trnVal, trainingActivity),
  cbind(testSubjects, testValues, testActivity)
)

# remove individual data tables to save memory
rm(trnSubj, trnVal, trainingActivity, 
